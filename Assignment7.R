...
#Using this table, we can see the numbers of people that survived in terms of gender and age grouping. I couldn't understand the question, because it asked to find averages, but there was only one ship sinking so I think the question was misworded.